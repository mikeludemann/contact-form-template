		...
		if($cfg['Sicherheitscode']) { ?>
			<div class="row captcha-row <?php if ($fehler["captcha"] != "") { echo 'error_container'; } ?>" style="background-image: url('img/border-right.png');background-position: 2.85rem center;-webkit-text-size-adjust:none;background-repeat: no-repeat;">
				<div class="col-sm-8 <?php if ($fehler["captcha"] != "") { echo 'error'; } ?>">
					...
					<div>
						<img aria-label="Captcha" src="captcha/captcha.php" alt="Sicherheitscode" title="Kontakt-sicherheitscode" id="captcha" />
			...
			<div class="row" id="send">
				<div class="col-sm-8">
					...
					<div style="text-align:center;">
						<!-- Dieser Copyrighthinweis darf NICHT entfernt werden. --><br /><br /><a href="https://www.example.com" title="Kontakt" style="text-decoration: none;color:#000000;font-size:13px;" target="_blank">&copy; by Admin - Alle Rechte vorbehalten.</a>
					</div>
