...
if ($_POST["kf-km"]) {
$empfaenger      = "no-reply@example.com";
...
$dsmsg = "". $_SERVER['HTTP_REFERER'] ."";
   ...
   $mailcontent .= "$dsmsg";
    	...
    	if(
    		...
    		$mailcontent  = "Wenn Sie diese E-Mail lesen können, wurde das Formular erfolgreich auf Ihrem Server getestet. Sie können nun die Datei test.php löschen.\n\n";
